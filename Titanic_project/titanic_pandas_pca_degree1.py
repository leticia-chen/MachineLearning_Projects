...
def main():
	...
	pca = decomposition.PCA(n_components=5)		# feature 降维变成5个
	x_train = pca.fit_transform(x_train)
	print('Var Retained: ', sum(pca.explained_variance_ratio_))		# 看保留多少
	...
	out_file(predictions, 'pandas_submission_degree1_pca_n=5.csv')
